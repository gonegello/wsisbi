...
?>
    ...
    <div class="row" style="margin-left:10%;margin-top:3%;">
      <div class="col">
      <h1 style="color:grey;"><a href="x-stock.php" class="stockroom"><i class="bx bx-store"></i> Stockroom</a><span style="font-size:20px;"> / <i class="bx bx-box"></i> <a href="x-full-ics.php" > ICS Items </a>
      / <a href="x-full-ics.php?#tobeiss">To be issued</a> / <?php echo $getfullname;?> </span> </h1>
    ...
    <div class="row" style="margin-top:2%;margin-left:10%;margin-right:10%;box-shadow: rgba(99, 99, 99, 0.2) 0px 1px 8px 0px;padding:0;border-radius:10px;">
     ...
     <div class="card-body" style="border-bottom:1px solid #ededed;border-top-right-radius:10px;border-top-left-radius:10px;background:royalblue;">
        ...
        <?php
                    ...
                    JOIN fund_c ON fund_c.fundc_id = xicspar.fc_id WHERE icspar_details.custodian = $idc AND icspar_details.icsxpar_no IS NULL GROUP BY xicspar.fc_id");
                    while($row=mysqli_fetch_array($query))
                    {
                  ...
                  <td> <a href="x-ics.php?fund_cluster=<?php echo $row['fund_cluster'];?>&idc=<?php echo $idc?>&fund_id=<?php echo $row['fundc_id'];?>">View</a><br></td>
                    </tr>
