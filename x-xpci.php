...
include "count-ris.php";
    ...
    <div class="col">
    <h1 style="color:grey;"><a href="x-reports.php" class="stockroom"> Reports</a><span style="font-size:20px;"> / <i class="bx bx-folder"></i> PCI</span></h1>

    </div>
    <div class="col" style="text-align:right;margin-top:1%;">
    <a href="x-pci.php" title="Add Article" class="second" ><i class="bx bx-dialpad-alt"></i> Add Article</a> |
            <a href="x-pci.php#list" title = "RIS request" class="second"><i class="bx bx-folder"></i> PCI List
    ...
    <div class="row" style="margin-top:2%;margin-left:10%;margin-right:10%;box-shadow: rgba(99, 99, 99, 0.2) 0px 1px 8px 0px;padding:0;border-radius:10px;">
     ...
     <div class="card-body" id="dash" style="border-bottom:1px solid #ededed;border-top-right-radius:10px;border-top-left-radius:10px;background:#A3A3FF;">
        <div class="row" style="margin-top:4%;">
           ...
           <h4 style="color:white;">Physical Count of Inventories</h4><span style="color:white;"></span>
           </div>
     </div>
        ...
        <div class="card-body" style="">
            <div class="row">
                ...
                <div class="col" style="margin-left:-40%;margin-top:1%;">
                    <span class="second">Fund Cluster 01</span>
                    <span></span>
                </div>
                <div class="col" style="text-align:right;margin-top:1%;">
                <a href="x-pc.php?fc=01&fc_id=1" class="chevlink" ><i class='bx bxs-chevron-right' style="font-size:25px;"></i></a>
                </div>
        ...
        <div class="card-body" style="">
            <div class="row">
                ...
                <div class="col" style="margin-left:-40%;margin-top:1%;">
                    <span class="second">Fund Cluster 05</span>
                    <span></span>
                </div>
                <div class="col" style="text-align:right;margin-top:1%;">
                <a href="x-pc.php?fc=05&fc_id=2" class="chevlink"><i class='bx bxs-chevron-right' style="font-size:25px;"></i></a>
                </div>
        ...
        <div class="card-body" style="border-bottom-right-radius:10px;border-bottom-left-radius:10px;">
            <div class="row">
                ...
                <div class="col" style="margin-left:-40%;margin-top:1%;">
                    <span class="second">Fund Cluster 07</span>
                    <span></span>
                </div>
                <div class="col" style="text-align:right;margin-top:1%;">
                <a href="x-pc.php?fc=07&fc_id=3" class="chevlink"><i class='bx bxs-chevron-right' style="font-size:25px;"></i></a>
                </div>
