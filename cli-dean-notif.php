...
<div class="container-fluid" style="background-color:whitesmoke;">
  <div class="card-shadow">
     ...
     <?php 
          ...
          if(isset($_SESSION['dean_approve']))
             {
      ?>
              ...
              </div><hr><i><?=$_SESSION['dean_approve'];?></i>
              </div>
             
      <?php 
          unset($_SESSION['dean_approve']);
            }
      ?>
...
<?php
      if($ris_ > 0 && $ics_ > 0)
      {
        echo '<a href="d-accept-pr.php?client_id='.$row['client_id'].'&r_date='.$row['r_date'].'&pr_no='.$row['pr_no'].'&h_id='.$row['h_id'].'&hd_aprvd='.$row['hd_aprvd'].'" id="link-a">';
      }
      else if($ris_ > 0 && $ics_ == 0)
      {
        echo '<a href="d-acc-ris.php?client_id='.$row['client_id'].'&r_date='.$row['r_date'].'&pr_no='.$row['pr_no'].'&h_id='.$row['h_id'].'&hd_aprvd='.$row['hd_aprvd'].'" id="link-a">';
        
      }
      else if($ics_ > 0 && $ris_ == 0)
      {
        echo '<a href="d-acc-ics.php?client_id='.$row['client_id'].'&r_date='.$row['r_date'].'&pr_no='.$row['pr_no'].'&h_id='.$row['h_id'].'&hd_aprvd='.$row['hd_aprvd'].'" id="link-a">';
