<?php
	...
	if(isset($_POST['query'])){
		...
		$search=$_POST['query'];
		$stmt=$conn->prepare("SELECT * FROM iar JOIN xicspar on xicspar.id_iar = iar.iar_id WHERE item_details LIKE CONCAT('%',?,'%') OR iar_no LIKE CONCAT('%',?,'%') group by id_iar order by iar_id desc limit 5");
                        ...
                        while($fetch=$result->fetch_assoc())
                        {
                          ...
                          <td>
                           ...
                           <td>
                            ...
                            <td><a href='x-iar-per.php?iar_id=".$fetch['iar_id']."' ><i class='bx bxs-chevron-right' style='font-size:20px;' ></i></a></td>
