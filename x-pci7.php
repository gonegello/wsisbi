...
<div class="row" style="margin-left:10%;margin-right:10%;margin-top:2%;position:-webkit-sticky;position:sticky;top:0;">
                    ...
                    <a href="x-pci5.php?#c5" class="line-button" role="button"> Cluster 05 </a>
                    <a href="x-pci7.php?#c7" class="line-button" role="button" style = "background:#E6A519;color:white;"> Cluster 07<i class='bx bx-check'></i> </a>
...
<div class="row" style="margin-top:2%;margin-left:10%;margin-right:10%;box-shadow: rgba(99, 99, 99, 0.2) 0px 1px 8px 0px;padding:0;border-radius:10px;">
     ...
     <div class="card-body" style="border-bottom:1px solid #ededed;border-top-right-radius:10px;border-top-left-radius:10px;background:royalblue;">
        ...
        <div class="card-body" style="background:whitesmoke;" id="f07">
        <div class="row">
          <div class="col">
...
<div class="row">
    ...
    <div class="row">
        ...
        <div class="card-body" style="background:whitesmoke;" id="c7">
        <div class="row">
          <div class="col">
              <h5 style="">Cluster 07</h5>
              <span><a href="x-pc.php?fc=07&fc_id=3"><i class='bx bx-file'></i>GENERATE REPORT</a></span>
   
    </div>
          <div class="col">
          <input type="text" name="search_stock7" id="search_stock7"  style="background:white;" placeholder="Search Stock">
          </div>
        </div>
...
<script>
 ...
 <script type="text/javascript">
        $(document).ready(function(){
            $("#search_stock7").keyup(function(){
                var search = $(this).val();
                $.ajax({
                    url:'search-xpci7.php',
                    method:'post',
                    data:{query:search},
