...
<div class="modal fade" id="parArchive<?=$row['idx'];?>" role="dialog" style="text-align:center;">
    <div class="modal-dialog modal=300px">
      <div class="modal-content">
       ...
       <div class="modal-body">
        ...
        <span style="color:grey;">It will be removed in active PAR Property.</span>

        <form method="post" action="x-a-in-par.php">
