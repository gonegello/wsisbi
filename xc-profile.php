...
input[type="text"]:hover, #office:focus{
...
if(isset($_POST["updateprof"]))
{
   ...
   header('location:xc-profile.php');  // executing insert query
  ...
  <div class="col" style="padding:0;background:#A3A3FF;border-top-right-radius:10px;border-bottom-right-radius:10px;">
     ...
     <br><span style="font-size:12px;">*click photo to change profile pic.</span>  
        ...
        border-bottom-right-radius:10px;">
            ...
            <div class="row">
                <div class="col">
                <label for="office">Office :<span style="font-style:italic;font-weight:bold;color:black;"> <?php echo $office;?></span></label>
           ...
           <select name="office" id="office" style="">
            ...
            <div class="col">
                ...
                <input type='text' name="position" id="position" placeholder="Position" value="<?php echo $position;?>" disabled>
                </div>
                <div class="col">
