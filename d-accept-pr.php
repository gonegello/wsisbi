     ...
     <!--Card header-->
      ...
      <div class="card-body" style="border-radius:5px;border:1px solid #ededed;border-bottom:none;
        ...
        <div class="row">
          ...
          <div class="col">
        <span style="color:grey;">Date of Request : <?php echo $r_date;?></span><br>
        ...
        <span><?php echo $hd_aprvd;?></span><br>
        ...
        <form method="post" action = "pr-d-accept.php">
        <table>
      ...
      ?>
        ...
        <tr>
            ...
            <input type="hidden" name="idcart2[]" value="<?php echo $row['idcart'];?>"/>
              <input type="hidden" name="dd_aprvd2[]" value="<?php echo $datte;?>"/>
              <input type="hidden" name ="stat2[]" value="3"/>
