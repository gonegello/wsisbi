...
<body style="background:whitesmoke;">
        ...
        <div class="row" style=" border:1px solid #ededed; border-top:none;
           ...
           Monthly & Yearly Report</span></a> <span style="font-size:20px; "> / Non-Consumable Item (PAR)</span></h1>
    ...
    <div class="section-to-print">
      <div class="row" style="margin-bottom:2%;">
          <div class="col">
              <h4>Report of Non-Consumables (PAR)</h4>
...
<?php
$stat = 1;
$query = mysqli_query($conn, "select * from `xicspar` join iar on iar.iar_id = xicspar.id_iar
left join fund_c on fund_c.fundc_id = xicspar.fc_id where xicspar.stat = $stat and xicspar.id_iar is not null and xicspar.unit_cost > 50000");
