  ...
  <div class="card-shadow">
     <!--Card header-->
      ...
      <div class="card-body" style="border-radius:5px;border:1px solid #ededed;border-bottom:none;
        ...
        <form method="post" action = "purchase-req.php">
        <table>
          ...
          <tr style="border-top:2px solid black;">
            ...
            <td>PR No. __________________</td>
            <td></td>
            <td>Date :</td>
        ...
        where stocks.int_typeid = $ics and cart.stat = '{$stat}' and cart.client_id = $id");
      ...
      ?>
        ...
        <tr>
            <td>
              ...
              <input type="hidden" name="r_date[]" value="<?php echo $datte;?>"/>
    ...
    ?>
      ...
      <tr>
        <td>Purpose:</td>
        <td colspan="4" style="border-bottom:2px solid black;"><input type="text" name="purpose" id="purpose" required=""></td>
        <td></td>  
      </tr>
