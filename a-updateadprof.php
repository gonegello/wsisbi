...
$save = mysqli_query($conn,"UPDATE `people` SET `lastname`= '$_POST[lastname]',`firstname` ='$_POST[firstname]',`m_initial` = '$_POST[m_initial]' 
...
WHERE `user_id` = '$_POST[userid]'");  // executing insert query
    ...
    if ($save)
    {
        $_SESSION['uprof'] = "Profile Updated Successfully!";
