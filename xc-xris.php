...
<div class="col">
<h1 style="color:grey;"><a href="xc-ris.php" class="stockroom"><i class="bx bx-folder"></i> RIS Record</a>
 <span style="font-size:20px;"> / <i class="bx bx-file"></i> <?php echo $ris_no;?></span></h1>
