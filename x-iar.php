...
<html lang="en" dir="ltr">
  <head>
    <meta charset="UTF-8">
    <title>Save as IAR No. <?php echo $iar_no;?>?</title>
...
?>
    ...
    $query=mysqli_query($conn,"select * from `xicspar`where idx = $idx");
...
<div class="row"style="margin-right:10%;margin-left:10%;margin-top:2%;">
           <div class="col">
            <a href="x-input-ics.php?#iar-ready" style="background:white;font-size:30px;padding:5px 11px;color:grey;border-radius:50%;">
     ...
     <div class="card-body" style=" border:1px solid #ededed; border-top:none;
      border-radius:10px;margin-right:10%;margin-left:10%;margin-bottom:10%;margin-top:5%;" >
    <div class="section-to-print">
     ...
     <br><br><br>
       ...
       <form method="post" action="save-iar.php">
        <table class="top">
                    <tr>
        ...
        <table>
            ...
            <tr>
                ...
                <td colspan="2" style="border-bottom:1px solid black;font-weight:bold;"><input type="text" style="font-weight:bold;color:black;" name="iar_no" id="iar_no" value="<?php echo $iar_no;?>"</td>
            ...
            <tr>
                ...
                <td colspan = "2">Date :</td>
                <td colspan="2" style="border-bottom:1px solid black;"><input type="text" name="in_date" id="in_date" style ="color:black;"></td>       
            </tr>
...
?>
            ...
            <?php
             ...
             <tr>
               ...
               <td style="border-top:1px solid black;border-bottom:1px solid black;color:white;border-right:3px solid black;">Missing</td>
               <td style="border-top:1px solid black;border-bottom:1px solid black;color:white;border-right:3px solid black;">Missing</td>
                <td style="border-top:1px solid black;border-bottom:1px solid black;color:white;">Missing</td>
            ...
            <tr>
                 ...
                 <td style="border-bottom:3px solid black;border-right:3px solid black;"></td>
                 <td style="border-bottom:3px solid black;border-right:3px solid black;"></td>
                 <td style="border-bottom:3px solid black;text-align:right;"><?php echo number_format($total_cost,2);?></td>
        ...
        <tr>
            <td colspan="2" style="border-right:3px solid black;">
                <div class="row">
                    ...
                    ">
                       <input type="text" name="chairperson" id="chairperson" style="text-align:center;text-transform:uppercase;color:black;font-weight:bold;" value="" required=""/>
                    </div>
                    <div class="col" style="text-align:center;">
                    <input type="text" name="member" id="member" style="text-align:center;text-transform:uppercase;color:black;font-weight:bold;" value="" required=""/>
            ...
            <input type="text" name="officer" id="officer" style="text-align:center;text-transform:uppercase;color:black;font-weight:bold;" value="" required=""/>
...
<div class="row">
    ...
    <div class="col" style="text-align:right;">
        <input type="submit" name="save" id="save" value="Save as IAR No. <?php echo $iar_no;?>">
    </div>
</div>
            </form>   
