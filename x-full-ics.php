...
?>
    ...
    <head>
    <meta charset="UTF-8">
    <title>Non-Consumable <= 50k</title>
...
<div class="row"style="margin-right:10%;margin-left:10%;margin-top:2%;">
 <div class="col">
 <h1 style="color:grey;"><a href="x-stock.php" class="stockroom"><i class="bx bx-store"></i> Stockroom</a><span style="font-size:20px;"> / <i class="bx bx-box"></i> ICS</span></h1></div>
 ...
 <a href="x-input-ics.php?#additemss" style="background:white;font-size:30px;padding:5px 11px;color:grey;border-radius:50%;">
    ...
    <div class="row" style="margin-top:2%;margin-left:10%;margin-right:10%;box-shadow: rgba(99, 99, 99, 0.2) 0px 1px 8px 0px;padding:0;border-radius:10px;">
     ...
     <div class="card-body" id="dash" style="border-bottom:1px solid #ededed;border-top-right-radius:10px;border-top-left-radius:10px;background:#A3A3FF;">
        <div class="row" style="">
        <div class="col" style="">
            <h5 style="color:white;"><i class="bx bx-box"></i><span> &nbsp; ICS</span></h5>
          ...
          <a href="#allics" title="All ICS Items" class="iar">All ICS Items <?php
         if($active_ics > 0)
         {
             echo '<span style="background:red;color:white;font-weight:bold;padding:5px 12px;border-radius:50px;
             font-size:15px;">'.$active_ics.'</span>';
         }

        
        
        ?></a> |
            <a href="#setcus" title = "Set Custodian" class="iar">Set Custodian <?php
         if($set_ics > 0)
         {
             echo '<span style="background:red;color:white;font-weight:bold;padding:5px 12px;border-radius:50px;font-size:15px;">'.$set_ics.'</span>';
         }
        ...
        ?></a> |
         ...
         if($tobeissued > 0)
         {
             echo '<span style="background:red;color:white;font-weight:bold;padding:5px 12px;border-radius:50px;font-size:15px;">'.$active_ics.'</span>';
         }
        ...
        ?>
            ...
            <a href="x-xics.php" title="ICS Records" class="iar">ICS Records</a> 
        ...
        <div class="card-body" style="background:whitesmoke;" id="allics">
        <div class="row">
          <div class="col" style="margin-top:1%;">
          <h6 style="color:grey;">Non-consumable items <= 50k</h6>

   
    </div>
          <div class="col">
  
          <input type="text"  id="icsinput" onkeyup="myFunctionn()" placeholder="Search by Items details, supplier.." style="background:white;border-radius:50px;">
...
if($active_ics == 0)
{
    ...
    <br><span style="color:grey;">Nothing recently added ICS item.</span><br><br>
...
?>
                ...
                if($active_ics > 0)
                {
                    echo '<table id="icstable">
                    <tr>
                    <th style="color:#A3A3FF;"></th>
                    <th  style="color:#A3A3FF;font-weight:bold;">Item Details</th>
                    <th style="color:#A3A3FF;font-weight:bold;">Supplier</th>
                    <th style="color:#A3A3FF;font-weight:bold;">Quantity</th>
                    <th style="color:#A3A3FF;font-weight:bold;">Unit Cost</th>
                    <th style="color:#A3A3FF;font-weight:bold;">Total Cost</th>
                    <th style="color:#A3A3FF;font-weight:bold;">Date</th>
                    <th style="color:#A3A3FF;font-weight:bold;">PO No.</th>
                    <th style="color:#A3A3FF;font-weight:bold;">PO Date</th>
                </tr>
                <tr>
...
?>
                ...
                $total = 0;
                 ...
                 $stat = "1";
                 $query=mysqli_query($conn,"SELECT * FROM xicspar JOIN fund_c ON fund_c.fundc_id = xicspar.fc_id JOIN classification ON 
                 classification.classID = xicspar.class_id
                  WHERE stat = $stat AND unit_cost <= 50000 AND id_iar IS NOT NULL ORDER BY idx DESC");
                 while($row=mysqli_fetch_array($query))
                {
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="#" class="opptions" data-toggle="modal" data-target="#icsArchive<?=$row['idx'];?>"><i class='bx bx-archive-in'></i></a>
...
?>
        ...
        <div class="card-body" style="background:whitesmoke;" id="tobeiss">
        <div class="row">
          <div class="col">
              <h6 style="color:grey;">TO BE ISSUED :</h6>
...
{
    echo '<tr>
    <td style="color:#A3A3FF;font-weight:bold;"></td>
    <td style="color:#A3A3FF;font-weight:bold;">Custodian</td>
    <td style="color:#A3A3FF;font-weight:bold;">PO No / PO Date</td>
    <td style="color:#A3A3FF;font-weight:bold;"></td>
</tr>';
...
?>
        ...
        <?php
                    ...
                    <tr>
                        ...
                        <td><a href="x-icsperson.php?idc=<?php echo $row['idc'];?>&count_fc=<?php echo $count_fc;?>&user_id=<?php echo $row['user_id'];?>" title="<?php echo $row['fullname'];?>" class="opptions"><i class='bx bxs-chevron-right' ></i></a></td>
        ...
        <div class="card-body" style="background:whitesmoke;" id="setcus">
        <div class="row">
          <div class="col">
          <h6 style="color:grey;">SET CUSTODIAN :</h6>
...
if($set_ics == 0)
{
    ...
    <div class="col" style="text-align:center;">
    <img src="image/none.jpg" style = "oject-fit:cover;"><br><br>
    <br><span style="color:grey;">No Item to set.</span><br><br><br>
    </div>
    <div class="col">
    </div>
    </div>
...
if($set_ics > 0)
{
    echo '  <tr>
    <td style="color:#A3A3FF;font-weight:bold;"></td>
    <td style="color:#A3A3FF;font-weight:bold;">Item Details</td>
    <td style="color:#A3A3FF;font-weight:bold;">Quantity</td>
    <td style="color:#A3A3FF;font-weight:bold;">Status</td>
    <td style="color:#A3A3FF;font-weight:bold;">PO No.</td>
    <td style="color:#A3A3FF;font-weight:bold;">PO Date</td>
    </tr>';
}
?>
                ...
                $query=mysqli_query($conn,"SELECT * FROM xicspar JOIN fund_c ON fund_c.fundc_id = xicspar.fc_id JOIN classification ON classification.classID = xicspar.class_id
                 WHERE stat = $stat AND xicspar.id_iar IS NOT NULL AND xicspar.unit_cost <= 50000 ORDER BY idx DESC");
                while($row=mysqli_fetch_array($query))
                {
                    $stock_id = $row['idx'];
...
function myFunctionn() {
  ...
  input = document.getElementById("icsinput");
  filter = input.value.toUpperCase();
  table = document.getElementById("icstable");
