    ...
    <div class="card-shadow">
        ...
        <div class="row">
            ...
            <div class="col">
                ...
                <div class="col">
                <h2>ICS</h2>
                <span>Non-Consumable Items Less than or equal to 15k</span>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col" style="text-align:right;">
                        <button type="button"><i class='bx bx-archive-in'></i> Archive</button>
                    </div>
                </div>
                ...
                $stat = "1";
                $query=mysqli_query($conn,"SELECT * FROM xicspar JOIN fund_c ON fund_c.fundc_id = xicspar.fc_id JOIN classification ON classification.classID = xicspar.class_id JOIN icspar_details ON icspar_details.x_id = Xicspar.idx
                ...
                while($row=mysqli_fetch_array($query))
                {
                    ...
                    <tr>
                        ...
                        <td> <img src="<?php echo $row['stock_img']; ?>" style="object-fit:cover;" width="100px" height="100px"></td>
                        ...
                        <td>
                            ...
                            if($row['id_iar'] == NULL)
                            {
                                echo '<a href="x-iar.php?fc_id='.$row['fc_id'].'&idx='.$row['idx'].'&fund_cluster='.$row['fund_cluster'].'&po_num='.$row['po_num'].'&po_date='.$row['po_date'].'
                                &date='.$row['date'].'&supplier='.$row['supplier'].'" title="Inspection And Acceptance Report">iar</a>';

                            }
                            else{
                                
                                    echo '<a href="x-iar-per.php?iar_id='.$row['id_iar'].'" title="Report">report</a>';
