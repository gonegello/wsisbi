...
<html lang="en" dir="ltr">
  <head>
    <meta charset="UTF-8">
    <title>IAR No. <?php echo $getiar_no;?></title>
...
?>
    ...
    <div class="col" style="text-align:right;">
            ...
            <a href="x-input-iar.php?#additemss" class="second" style=";font-size:25px;color:grey;border-radius:50%;">
            <i class='bx bx-mouse'> RIS Acceptance</i></a>
    </div>
        ...
        <form action="export-xrisper.php?iar_id=<?php echo $iar_id; ?>" method="post">
     ...
     <br><br><br>
       ...
       <form method="post" action="#">
        ...
        <table>
            ...
            $total_cost = 0;
            $query = mysqli_query($conn, "select * from `xris`
